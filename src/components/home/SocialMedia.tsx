...
export const SocialMedia = () => {
  return (
    <div className='bg-white grid grid-cols-2 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-16 gap-8 sm:gap-10 md:gap-12 lg:gap-14 xl:gap-16 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>
